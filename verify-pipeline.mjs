...
import { CANONICAL_STATUSES, ALIASES } from './lib/status.mjs';
...
// CANONICAL_STATUSES + ALIASES now live in the shared lib/status.mjs.
...
let dupes = 0;
for (const e of entries) {
  const key = canonKey(e.company, e.role);
