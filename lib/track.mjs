...
export function titlePassesForTrack(track, title) {
  ...
  if (track === 'civic') {
    return /\b(product|program|project|digital|technology|data|analytics|innovation|service design|user experience|strategy|transformation|chief of staff|advisor)\b/i.test(t)
